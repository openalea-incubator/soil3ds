...
def test_baresoil():
    ...
    meteo_path = os.path.join(path_leg, 'meteo_exemple.xls')
    ongletM = 'Lusignan30'
    meteo = IOxls.read_met_file(meteo_path, ongletM)

    ## lecture fichier management
    mn_path = os.path.join(path_leg, 'management_exemple.xls')
    ongletMn = 'Lusignan30IrrN2'
